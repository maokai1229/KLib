...
/**
 * Provides fake dragging functionality to {@link ViewPager2Ex}.
 */
final class FakeDrag {
    private final ViewPager2Ex mViewPager;
    ...
    FakeDrag(ViewPager2Ex viewPager, ScrollEventAdapter scrollEventAdapter,

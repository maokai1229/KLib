...
import com.ethanmao.klib.vp2.widget.ViewPager2Ex;

import java.util.Set;

/**
 * Similar in behavior to {@link}
 * <p>
...
public abstract class FragmentStateAdapter extends
    ...
    /**
     * @param fragmentActivity if the {@link ViewPager2Ex} lives directly in a*
    ...
    /**
     * @param fragment if the {@link ViewPager2Ex} lives directly in a {@link Fragment} subclass.
     *
    ...
    /**
     * @param fragmentManager of {@link ViewPager2Ex}'s host
     * @param lifecycle of {@link ViewPager2Ex}'s host
     *
     * @see FragmentStateAdapter#FragmentStateAdapter(FragmentActivity)
     * @see FragmentStateAdapter#FragmentStateAdapter(Fragment)
     */
     ...
     * </ul>
     * @see ViewPager2Ex#setOffscreenPageLimit
     */
    ...
    public final void restoreState(@NonNull Parcelable savedState) {
        ...
        if (bundle.getClassLoader() == null) {
            /** TODO(b/133752041): pass the class loader from {@link ViewPager2Ex.SavedState } */
    ...
    class FragmentMaxLifecycleEnforcer {
        private ViewPager2Ex.OnPageChangeCallback mPageChangeCallback;
        private RecyclerView.AdapterDataObserver mDataObserver;
        private LifecycleEventObserver mLifecycleObserver;
        private ViewPager2Ex mViewPager;
        ...
        void register(@NonNull RecyclerView recyclerView) {
            ...
            mPageChangeCallback = new ViewPager2Ex.OnPageChangeCallback() {
                @Override
        ...
        void unregister(@NonNull RecyclerView recyclerView) {
            ViewPager2Ex viewPager = inferViewPager(recyclerView);
        ...
        void updateFragmentMaxLifecycle(boolean dataSetChanged) {
            ...
            if (mViewPager.getScrollState() != ViewPager2Ex.SCROLL_STATE_IDLE) {
            ...
            if (currentItem >= getItemCount()) {
                 ...
                 * notified via {@link ViewPager2Ex.OnPageChangeCallback#onPageSelected(int)}  */
                return;
            }
        ...
        @NonNull
        private ViewPager2Ex inferViewPager(@NonNull RecyclerView recyclerView) {
            ViewParent parent = recyclerView.getParent();
            if (parent instanceof ViewPager2Ex) {
                return (ViewPager2Ex) parent;
            }

...
/**
 * Translates {@link ViewPager2Ex.OnPageChangeCallback} events to {@link ViewPager2Ex.PageTransformer} events.
 */
final class PageTransformerAdapter extends ViewPager2Ex.OnPageChangeCallback {
    private final LinearLayoutManager mLayoutManager;

    private ViewPager2Ex.PageTransformer mPageTransformer;

    PageTransformerAdapter(LinearLayoutManager layoutManager) {
        mLayoutManager = layoutManager;
    }

    ViewPager2Ex.PageTransformer getPageTransformer() {
     ...
     */
    void setPageTransformer(@Nullable ViewPager2Ex.PageTransformer transformer) {

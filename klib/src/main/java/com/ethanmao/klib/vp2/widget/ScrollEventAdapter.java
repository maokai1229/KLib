...
import static com.ethanmao.klib.vp2.widget.ViewPager2Ex.SCROLL_STATE_DRAGGING;
import static com.ethanmao.klib.vp2.widget.ViewPager2Ex.SCROLL_STATE_IDLE;
import static com.ethanmao.klib.vp2.widget.ViewPager2Ex.SCROLL_STATE_SETTLING;
...
/**
 * Translates {@link RecyclerView.OnScrollListener} events to {@link ViewPager2Ex.OnPageChangeCallback} events
 * for {@link ViewPager2Ex}. As part of this process, it keeps track of the current scroll position
...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private ViewPager2Ex.OnPageChangeCallback mCallback;
    private final @NonNull ViewPager2Ex mViewPager;
    ...
    private @ViewPager2Ex.ScrollState int mScrollState;
    ...
    ScrollEventAdapter(@NonNull ViewPager2Ex viewPager) {
    ...
    void setOnPageChangeCallback(ViewPager2Ex.OnPageChangeCallback callback) {
        mCallback = callback;
    }
     ...
     *         {@link ViewPager2Ex#endFakeDrag()} is called.
     */
     ...
     * the ViewPager is settling towards its {@link ViewPager2Ex#getCurrentItem() current item}, or
    ...
    private void dispatchStateChanged(@ViewPager2Ex.ScrollState int state) {

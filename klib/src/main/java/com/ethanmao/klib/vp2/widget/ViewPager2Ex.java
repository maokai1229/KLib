...
import com.ethanmao.klib.vp2.adapter.FragmentStateAdapter;
import com.ethanmao.klib.vp2.adapter.StatefulAdapter;
 ...
 * ViewPager
 */
public final class ViewPager2Ex extends ViewGroup {
    /** @hide */
    ...
    public ViewPager2Ex(@NonNull Context context) {
        super(context);
        initialize(context, null);
    }

    public ViewPager2Ex(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public ViewPager2Ex(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * implement {@link  FragmentStateAdapter}. If
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final AccessibilityViewCommand mActionPageForward =
                new AccessibilityViewCommand() {
                    ...
                    public boolean perform(@NonNull View view,
                        ...
                        ViewPager2Ex viewPager = (ViewPager2Ex) view;
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
            ...
            if (ViewCompat.getImportantForAccessibility(ViewPager2Ex.this)
                    == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                ViewCompat.setImportantForAccessibility(ViewPager2Ex.this,
        ...
        public void onRvInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            event.setSource(ViewPager2Ex.this);
        ...
        void updatePageAccessibilityActions() {
            ViewPager2Ex viewPager = ViewPager2Ex.this;
